(function (global, factory) {
  ...
  (global = global || self, factory(global.yup));
  ...
  var nativeGetOwnPropertyDescriptor$1 = Object.getOwnPropertyDescriptor; // Nashorn ~ JDK8 bug

  var NASHORN_BUG = nativeGetOwnPropertyDescriptor$1 && !nativePropertyIsEnumerable.call({
    1: 2
  }, 1);
  var f = NASHORN_BUG ? function propertyIsEnumerable(V) {
    var descriptor = nativeGetOwnPropertyDescriptor$1(this, V);
  ...
  var f$1 = descriptors ? nativeGetOwnPropertyDescriptor$2 : function getOwnPropertyDescriptor(O, P) {
    O = toIndexedObject(O);
  ...
  var enumKeys = function enumKeys(it) {
  ...
  var Empty = function Empty() {}; // Create object with fake `null` prototype: use iframe Object with cleared prototype
  ...
  var setSymbolDescriptor = descriptors && fails(function () {
    ...
    var ObjectPrototypeDescriptor = nativeGetOwnPropertyDescriptor$3(ObjectPrototype, key);
  ...
  var $getOwnPropertyNames = function getOwnPropertyNames(it) {
    var names = nativeGetOwnPropertyNames$2(toIndexedObject(it));
    var result = [];
    var i = 0;
    var key;
  ...
  var $getOwnPropertySymbols = function getOwnPropertySymbols(it) {
    ...
    var names = nativeGetOwnPropertyNames$2(IS_OP ? ObjectPrototypeSymbols : toIndexedObject(it));
    var result = [];
    var i = 0;
    var key;
  ...
  var Reflect = global$1.Reflect; // all object keys, includes non-enumerable and symbols
  ...
  */
  ...
  var FORCED$2 = !IS_CONCAT_SPREADABLE_SUPPORT || !SPECIES_SUPPORT$1; // `Array.prototype.concat` method
  ...
  var SLOPPY_METHOD$1 = sloppyArrayMethod('every'); // `Array.prototype.every` method
  // https://tc39.github.io/ecma262/#sec-array.prototype.every
  ...
  var SPECIES_SUPPORT$2 = arrayMethodHasSpeciesSupport('filter'); // `Array.prototype.filter` method
  // https://tc39.github.io/ecma262/#sec-array.prototype.filter
  ...
  var SLOPPY_METHOD$2 = sloppyArrayMethod('forEach'); // `Array.prototype.forEach` method implementation
  // https://tc39.github.io/ecma262/#sec-array.prototype.foreach

  var arrayForEach = SLOPPY_METHOD$2 ? function forEach(callbackfn
  /* , thisArg */
  ) {
  ...
  var SLOPPY_METHOD$3 = sloppyArrayMethod('indexOf'); // `Array.prototype.indexOf` method
  // https://tc39.github.io/ecma262/#sec-array.prototype.indexof

  _export({
    target: 'Array',
    proto: true,
    forced: NEGATIVE_ZERO || SLOPPY_METHOD$3
  }, {
  ...
  var SLOPPY_METHOD$4 = sloppyArrayMethod('lastIndexOf'); // `Array.prototype.lastIndexOf` method implementation
  // https://tc39.github.io/ecma262/#sec-array.prototype.lastindexof

  var arrayLastIndexOf = NEGATIVE_ZERO$1 || SLOPPY_METHOD$4 ? function lastIndexOf(searchElement
  /* , fromIndex = @[*-1] */
  ) {
    // convert -0 to +0
  ...
  var SPECIES_SUPPORT$3 = arrayMethodHasSpeciesSupport('map'); // `Array.prototype.map` method
  // https://tc39.github.io/ecma262/#sec-array.prototype.map
  // with adding support of @@species
  ...
  var SLOPPY_METHOD$5 = sloppyArrayMethod('reduce'); // `Array.prototype.reduce` method
  // https://tc39.github.io/ecma262/#sec-array.prototype.reduce

  _export({
    target: 'Array',
    proto: true,
    forced: SLOPPY_METHOD$5
  }, {
  ...
  var SLOPPY_METHOD$6 = sloppyArrayMethod('reduceRight'); // `Array.prototype.reduceRight` method
  // https://tc39.github.io/ecma262/#sec-array.prototype.reduceright

  _export({
    target: 'Array',
    proto: true,
    forced: SLOPPY_METHOD$6
  }, {
  ...
  var SLOPPY_METHOD$7 = sloppyArrayMethod('some'); // `Array.prototype.some` method
  // https://tc39.github.io/ecma262/#sec-array.prototype.some

  _export({
    target: 'Array',
    proto: true,
    forced: SLOPPY_METHOD$7
  }, {
  ...
  var FORCED$3 = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || SLOPPY_METHOD$8; // `Array.prototype.sort` method
  ...
  var SPECIES_SUPPORT$4 = arrayMethodHasSpeciesSupport('splice'); // `Array.prototype.splice` method
  ...
  var FORCED$5 = forcedStringTrimMethod('trim'); // `String.prototype.trim` method
  ...
  if (isForced_1(NUMBER, !NativeNumber(' 0o1') || !NativeNumber('0b1') || NativeNumber('+0x1'))) {
    var NumberWrapper = function Number(value) {
      ...
      }) : classofRaw(that) != NUMBER) ? inheritIfRequired(new NativeNumber(toNumber(it)), that, NumberWrapper) : toNumber(it);
    };
    ...
    'EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,' + 'MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger').split(','), j = 0, key; keys$1.length > j; j++) {
      if (has(NativeNumber, key = keys$1[j]) && !has(NumberWrapper, key)) {
        defineProperty$5(NumberWrapper, key, getOwnPropertyDescriptor$1(NativeNumber, key));
      }
    }
  ...
  _export({
    target: 'Number',
    proto: true,
    forced: nativeToFixed && (0.00008.toFixed(3) !== '0.000' || 0.9.toFixed(0) !== '1' || 1.255.toFixed(2) !== '1.25' || 1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !fails(function () {
      // V8 ~ Android 4.3-
      nativeToFixed.call({});
    })
  }, {
  ...
  var validateStringMethodArguments = function validateStringMethodArguments(that, searchString, NAME) {
  ...
  var min$5 = Math.min;
  var CORRECT_IS_REGEXP_LOGIC = correctIsRegexpLogic(ENDS_WITH); // `String.prototype.endsWith` method
  ...
  var FORCED$6 = forcedStringTrimMethod('trimEnd');
